          ...
          >
            {post.heroImage ? (
              <div className="h-36 overflow-hidden relative">
                <img src={post.heroImage} alt={post.title} className="w-full h-full object-cover group-hover:scale-105 transition-transform duration-300" loading="lazy" />
                <div className="absolute top-3 left-3">
                  <span className="bg-white/90 text-[#1A202C] text-xs font-medium px-2.5 py-0.5 rounded-full">
                    {post.category}
                  </span>
                </div>
              </div>
